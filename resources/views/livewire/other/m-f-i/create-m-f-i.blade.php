<div wire:ignore.self class="modal fade" id="openModal">
    <div class="modal-dialog modal-xl">
        <form action="" wire:submit.prevent="createMFI">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="text fw-semibold">{{__('Add New MFI')}}</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4 mb-3">
                            ...
                            <input type="text" wire:model="name" class="form-control @error('name') is-invalid @enderror" placeholder="{{__('Full Name (English)')}}">
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <input type="text" wire:model="name_translate" class="form-control @error('name_translate') is-invalid @enderror" placeholder="{{__('Full Name (Khmer)')}}">
